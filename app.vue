      ...
      <div class="w-full max-w-md bg-white rounded-xl shadow-2xl p-8 space-y-6">
        ...
        <div class="relative">
          ...
          <div class="absolute right-3 top-10">
            <button v-if="showSuggestions"
            @click="closeMercSuggestions" class="text-gray-500 hover:text-gray-700">Cerrar</button>
          </div>
            ...
            <div class="space-y-4">
                    ...
                    >
                      <ul class="divide-y divide-gray-200">
                        <li
                          ...
                          style="color: #4e4e4d"
                        >
                          <span style="color: #e89e16">{{ product.codigo }}</span> - {{ product.descripcion }}
              ...
              <div class="border-t-2 pt-6" style="border-color: #ebbe1c30">
                ...
                <ul v-else class="space-y-3">
                  ...
                  >
                    <div class="flex-1">
                      <p class="font-medium" style="color: #4e4e4d">{{ product.descripcion }}</p>
...
export default {
  data() {
    return {
      ...
      selectedProduct: { codigo: '', descripcion: '', linea: '', cantidad: 0 },
      mercadistas: [
  ...
  methods: {
    ...
    clearProductQuery() {
      this.productQuery = ''
      this.selectedProduct = { codigo: '', descripcion: '', linea: '', cantidad: 0 }
      this.showProductSuggestions = false
    }
